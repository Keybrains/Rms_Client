                                        ...
                                        {({ values, errors, touched, handleBlur, handleChange }) => (
                                            <Form>
                                                ...
                                                {showBillingPeriods && (
                                                    <div className="mb-3 col-lg-8">
                                                        ...
                                                        {touched.plan_periods && errors.plan_periods && (
                                                            <div className="text-danger">{errors.plan_periods}</div>
                                                        )}
                                                    </div>
                                                )}
                                                <div className="mb-3 mx-3">
                                                    ...
                                                    <div className="mb-2">
                                                        <FormControlLabel
                                                            control={<Checkbox checked={values.earlyCancellationFee} onChange={handleChange} name="earlyCancellationFee" />}
                                                            label={<span style={{ fontSize: "0.8rem" }}>Set early membership cancellation fee</span>}
                                                        />
                                                    </div>
                                                    <div className="mb-2">
                                                        <FormControlLabel
                                                            control={<Checkbox checked={values.changePlan} onChange={handleChange} name="changePlan" />}
                                                            label={<span style={{ fontSize: "0.8rem" }}>Allow member to change plan</span>}
                                                        />
                                                    </div>
                                                    <div className="mb-2">
                                                        <FormControlLabel
                                                            control={<Checkbox checked={values.cancelMembership} onChange={handleChange} name="cancelMembership" />}
                                                            label={<span style={{ fontSize: "0.8rem" }}>Allow member to cancel billing/membership</span>}
                                                        />
                                                    </div>
                                                    <div className="mb-2">
                                                        <FormControlLabel
                                                            control={<Checkbox checked={values.pauseMembership} onChange={handleChange} name="pauseMembership" />}
                                                            label={<span style={{ fontSize: "0.8rem" }}>Allow member to pause billing/membership</span>}
                                                        />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="mb-3 mx-2">
                                                    <Button className="mt-3" type="submit" variant="success">Add Plan</Button>
                                                    <Button className="mt-3" type="" variant="" onClick={() => navigate("/superadmin/plans")}>Cancel</Button>
                                                </div>
                                                {/* <div className="mb-3">
