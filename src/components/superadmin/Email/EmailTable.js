  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <TableCell align="center">{row?.secure ? "True" : "False"}</TableCell>
        <TableCell align="center">{row?.from_name}</TableCell>
        <TableCell align="center">{row?.from_email}</TableCell>
...
const EmailTable = () => {
  ...
  const getData = async () => {
    try {
      const res = await axios.get(`${baseUrl}/email_configration`, {
        params: {
