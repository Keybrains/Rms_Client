...
const WorkOrderDetails = () => {
    ...
    const getOutstandData = async () => {
      try {
        const response = await axios.get(`http://localhost:4000/api/workorder/workorder_summary/${workorder_id}`);
                                ...
                                <Table className="align-items-center table-flush" responsive style={{width:"100%"}}>
                                    {loading ? (
                                        ...
                                        <>
                                            <tbody >
                                                <tr>
                                                    <th colSpan="2" className="text-primary text-lg">{outstandDetails.work_subject}</th>
                                                </tr>  
                                                <tr>
                                ...
                                <Box border="1px solid #ccc" borderRadius="8px" padding="16px" maxWidth="700px" margin={'20px'}>
                                  <Row>
                                    ...
                                    <Col lg="8">
                                      ...
                                      <h2 className="text-primary text-lg">{outstandDetails.work_subject || "N/A"}</h2>
