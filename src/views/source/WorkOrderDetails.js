                    ...
                    <Col lg="4" md="12">
                      {outstandDetails?.workOrder_id ? (
                        ...
                        >
                          ...
                          >
                            <span className="text" style={{ color: "#152B51", fontWeight: "500", fontFamily: "Poppins", fontSize: "16px", }}
                            >
                              Contacts
                            </span>
                          </Box>
                          ...
                          >
                            ...
                            >
                              <span style={{ color: "#152B51", fontWeight: "500", fontFamily: "Poppins", fontSize: "16px", }}>Vendor</span> <br />
                              <span style={{
                                fontWeight: "400",
                                fontFamily: "Poppins",
                                fontSize: "14px",
                          ...
                          {outstandDetails?.tenant_data &&
                            ...
                            >
                              ...
                              >
                                <span style={{ color: "#152B51", fontWeight: "500", fontFamily: "Poppins", fontSize: "16px", }}>Tenant</span> <br />
                                <span style={{
                                  fontWeight: "400",
                                  fontFamily: "Poppins",
                                  fontSize: "14px",
